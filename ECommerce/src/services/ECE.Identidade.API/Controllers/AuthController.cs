...
namespace ECE.Identidade.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Registrar(UsuarioRegistro usuarioRegistro)
        {
            ...
            {
                AdicionarErroProcessamaento(error.Description);
            }
        ...
        public async Task<ActionResult> Login(UsuarioLogin usuarioLogin)
        {
            ...
            {
                AdicionarErroProcessamaento("Usuário temporariamente bloqueado por tentativas inválidas");
                return CustomResponse();
            }

            AdicionarErroProcessamaento("Usuário ou Senha incorretos");
