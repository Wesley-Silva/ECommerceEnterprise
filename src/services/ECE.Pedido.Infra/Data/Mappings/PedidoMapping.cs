...
namespace ECE.Pedido.Infra.Data.Mappings
{
    public class PedidoMapping : IEntityTypeConfiguration<ECE.Pedido.Domain.Pedidos.Pedido>
    {
        public void Configure(EntityTypeBuilder<ECE.Pedido.Domain.Pedidos.Pedido> builder)
        {
